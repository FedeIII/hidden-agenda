...
`;function Dc(){return(0,q.jsxs)(Ec,{viewBox:`0 0 120 120`,"aria-hidden":`true`,focusable:`false`,children:[(0,q.jsx)(`polygon`,{points:`60,10 103.3,35 103.3,85 60,110 16.7,85 16.7,35`,fill:`none`,stroke:`#a3282b`,strokeWidth:`7`}),(0,q.jsx)(`text`,{x:`60`,y:`76`,textAnchor:`middle`,fontFamily:`'American Typewriter', 'Courier New', Courier, monospace`,fontWeight:`700`,fontSize:`44`,letterSpacing:`-1`,fill:`#a3282b`,children:`HA`})]})}var Oc=G.div`
	display: flex;
	align-items: center;
	justify-content: center;
	gap: 8px;
...
`;function Mc(){let e=dc(),t=pc(),n=mc();return t?(0,q.jsxs)(Oc,{id:`skin-picker`,children:[(0,q.jsx)(kc,{children:`Style`}),(0,q.jsx)(Ac,{children:$t.map(t=>(0,q.jsx)(jc,{id:`skin-option-${t}`,type:`button`,current:t===e,"aria-pressed":t===e,onClick:()=>n(t),children:t},t))})]}):null}function Nc({id:e=`leave-game`,label:t=`LEAVE`,small:n=!0,onClick:r}){let{mode:i,actions:a}=Ws();return i===`online`?(0,q.jsx)(wc,{id:e,small:n,active:!0,onClick:r||a.leave,children:t}):null}var Pc=`secret.hidden.silent.quiet.cunning.ruthless.patient.restless.nameless.faceless.double.crooked.loyal.wary.invisible.sleeping.burning.frozen.broken.gilded.hollow.velvet.brittle.candid.careless.discreet.elusive.forged.guarded.idle.jaded.keen.lonely.masked.nervous.obscure.polite.reckless.sealed.shadowed.sly.sombre.stolen.sunken.tangled.unseen.vacant.veiled.watchful.wounded.absent.bitter.clever.deadly.eager.false.grim.humble.impatient.unlucky`.split(`.`),Fc=`agent.spy.traitor.courier.handler.mole.cipher.dossier.envelope.ledger.whisper.rumour.alias.briefcase.keyhole.lantern.matchbook.notebook.passport.postcard.signal.stamp.telegram.typewriter.umbrella.vault.wireless.safehouse.sniper.chauffeur.diplomat.informant.defector.custodian.gatekeeper.interpreter.janitor.librarian.locksmith.messenger.minister.nightwatch.operator.photographer.quartermaster.receptionist.secretary.sentry.steward.switchboard.telephonist.understudy.waiter.watchman.cartographer.bookkeeper.clockmaker.tailor.translator.stenographer`.split(`.`);function Ic(e=Math.random){return`${Pc[Math.floor(e()*Pc.length)%Pc.length]}-${Fc[Math.floor(e()*Fc.length)%Fc.length]}`}function Lc(e){return typeof e==`string`?e.trim().replace(/\s+/g,` `).replace(/-+/g,`-`):``}function Rc(e){let t=Lc(e);return t.length>=3&&t.length<=24&&/^[A-Za-z0-9][A-Za-z0-9 -]*$/.test(t)}var zc=G.div`
	display: flex;
	flex-direction: column;
	align-items: center;
	gap: 18px;
...
`,ol=G.span`
	...
	text-transform: uppercase;
	color: var(--ha-ink-faint);
`,sl=200,cl={no_such_room:`No room with that code.`,room_full:`That room is full.`,name_taken:`Somebody in that room already has that name.`,room_already_started:`That game has already started.`,not_enough_players:`Wait for at least 2 players.`,seat_lost:`Your seat is gone. Join again with a name.`,server_full:`The server is at its room limit. Try again shortly.`,slow_down:`Too many attempts. Wait a moment.`,not_host:`Only the player who made the room can start it.`,skin_locked:`The style cannot be changed once the game has started.`,bad_skin:`No such style.`,bad_room_name:`A room name is letters, digits, spaces and hyphens.`,already_seated:`You are already at a table.`,left_alone:`Everybody else left, so the game ended.`};function ll(e){if(!Number.isFinite(e))return`You left a game in progress. Wait a moment before starting another.`;let t=Math.ceil(e/60);return`You left a game in progress. You can play again in ${e<60?`${e}s`:`${t} min`}.`}function ul(e,t=null){return e===`quit_timeout`?ll(t):cl[e]||e}function dl({canGo:e,onCreate:t}){let[n,r]=(0,v.useState)(Ic),[i,a]=(0,v.useState)(!0),o=Rc(n);return(0,q.jsxs)(Zc,{children:[(0,q.jsx)(vc,{children:`New room`}),(0,q.jsxs)(Yc,{children:[(0,q.jsx)(Jc,{id:`lobby-room-name`,value:n,maxLength:24,placeholder:`ROOM NAME`,onChange:e=>r(e.target.value)}),(0,q.jsx)(wc,{id:`lobby-room-reroll`,small:!0,active:!0,onClick:()=>r(Ic()),children:`↻`})]}),(0,q.jsxs)(il,{id:`lobby-visibility`,children:[(0,q.jsx)(ol,{children:`Listed`}),(0,q.jsx)(al,{id:`lobby-visibility-public`,type:`button`,current:i,"aria-pressed":i,onClick:()=>a(!0),children:`Public`}),(0,q.jsx)(al,{id:`lobby-visibility-private`,type:`button`,current:!i,"aria-pressed":!i,onClick:()=>a(!1),children:`Private`})]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`lobby-create`,active:e&&o,onClick:()=>e&&o&&t({room:n.trim(),isPrivate:!i}),children:`NEW ROOM`})}),!o&&(0,q.jsx)(Xc,{id:`lobby-room-name-bad`,children:ul(`bad_room_name`)}),!i&&(0,q.jsx)(Xc,{id:`lobby-private-hint`,children:`A private room is found by its code alone.`})]})}function fl({rooms:e,total:t,query:n,onQuery:r,canGo:i,held:a,onEnter:o,unreachable:s}){return(0,q.jsxs)(Zc,{children:[(0,q.jsx)(vc,{children:`Find a room`}),(0,q.jsx)(Jc,{id:`lobby-search`,value:n,maxLength:24,placeholder:`SEARCH BY NAME`,onChange:e=>r(e.target.value)}),s&&(0,q.jsx)(Xc,{id:`lobby-rooms-offline`,children:`The room list needs a server to ask.`}),!s&&e.length===0&&(0,q.jsx)(Xc,{id:`lobby-rooms-empty`,children:n.trim()?`No public room by that name.`:`No public rooms yet. Open one.`}),e.length>0&&(0,q.jsx)(Qc,{id:`lobby-rooms`,children:e.map(e=>{let t=a.has(e.code),n=e.state===pn.LOBBY&&e.players<6,r=t||n&&i;return(0,q.jsx)(`li`,{children:(0,q.jsxs)($c,{id:`lobby-room-${e.code}`,type:`button`,joinable:r,disabled:!r,"data-room-name":e.name,"data-room-host":e.host||``,"data-room-players":e.players,"data-room-state":e.state,...Number.isFinite(e.rating)?{"data-room-rating":e.rating}:{},onClick:()=>o(e.code),children:[(0,q.jsx)(el,{children:e.name}),(0,q.jsxs)(nl,{children:[(0,q.jsx)(`span`,{children:e.host}),Number.isFinite(e.rating)&&(0,q.jsx)(Kc,{children:e.rating}),(0,q.jsxs)(`span`,{children:[e.players,`/`,6]}),(0,q.jsx)(rl,{open:n,children:t?`yours`:e.state})]})]})},e.code)})}),t>e.length&&(0,q.jsxs)(Xc,{id:`lobby-rooms-more`,children:[`Showing `,e.length,` of `,t,`. Search to narrow it.`]}),e.length>0&&!i&&(0,q.jsx)(Xc,{id:`lobby-rooms-need-name`,children:`Say who you are first.`})]})}function pl({seats:e,onEnter:t}){return e.length?(0,q.jsxs)(Zc,{children:[(0,q.jsx)(vc,{children:`You are in a game`}),(0,q.jsx)(Qc,{id:`lobby-resume`,children:e.map(e=>(0,q.jsx)(`li`,{children:(0,q.jsxs)($c,{id:`lobby-resume-${e.code}`,type:`button`,joinable:!0,"data-room-name":e.room||e.code,onClick:()=>t(e.code),children:[(0,q.jsx)(el,{children:e.room||e.code}),(0,q.jsxs)(nl,{children:[(0,q.jsx)(`span`,{children:e.name}),(0,q.jsx)(rl,{open:!0,children:`resume`})]})]})},e.code))})]}):null}function ml({canGo:e,queue:t,onQueue:n,onCancel:r}){let i=!!t;return(0,q.jsxs)(Zc,{children:[(0,q.jsx)(vc,{children:`Automatch`}),(0,q.jsxs)(Yc,{children:[(0,q.jsx)(wc,{id:`lobby-queue`,small:!0,active:e||i,onClick:i?r:n,children:i?`CANCEL`:`FIND ME A GAME`}),i&&(0,q.jsxs)(ol,{id:`lobby-queue-status`,"data-waiting":t.waiting,children:[`Searching — `,t.waiting,` waiting`,Number.isFinite(t.rating)?`, you are on ${t.rating}`:``,t.window===null?`, any rating`:``]})]}),!e&&!i&&(0,q.jsx)(Xc,{id:`lobby-queue-need-name`,children:`Say who you are first.`})]})}function hl({rated:e,playerName:t}){let n=e?.players?.find(e=>e.name===t);return!n||!n.delta?null:(0,q.jsxs)(Xc,{id:`lobby-last-game`,"data-delta":n.delta,children:[`Last game: `,n.delta>0?`+`:`−`,Math.abs(n.delta),` — you are on `,n.after,`.`]})}function gl({session:e,unreachable:t}){let{code:n,rooms:r,roomsTotal:i,resumable:a,playerName:o,queue:s,rated:c,actions:l}=e,{createRoom:u,joinRoom:d,listRooms:f,stopListing:p,queueUp:m,cancelQueue:h}=l,[g,_]=(0,v.useState)(()=>o||``),[y,b]=(0,v.useState)(n||``),[x,S]=(0,v.useState)(``),C=g.trim(),w=C.length>0,T=new Set(a.map(e=>e.code));(0,v.useEffect)(()=>{let e=setTimeout(()=>f(x),sl);return()=>clearTimeout(e)},[x,f]),(0,v.useEffect)(()=>p,[p]);let E=(0,v.useCallback)(e=>d(e,C),[d,C]),D=(0,v.useCallback)(e=>w&&u(C,e),[w,u,C]),O=(0,v.useCallback)(()=>w&&y.trim().length===4&&E(y.trim().toUpperCase()),[w,E,y]);return(0,q.jsxs)(Bc,{children:[(0,q.jsx)(vc,{children:`Your name`}),(0,q.jsx)(Jc,{id:`lobby-name`,value:g,maxLength:16,placeholder:`NAME`,onChange:e=>_(e.target.value.toUpperCase())}),(0,q.jsx)(hl,{rated:c,playerName:o}),(0,q.jsx)(pl,{seats:a,onEnter:E}),(0,q.jsx)(ml,{canGo:w,queue:s,onQueue:()=>w&&m(C),onCancel:h}),(0,q.jsx)(dl,{canGo:w,onCreate:D}),(0,q.jsx)(fl,{rooms:r,total:i,query:x,onQuery:S,canGo:w,held:T,onEnter:E,unreachable:t}),(0,q.jsxs)(Zc,{children:[(0,q.jsx)(vc,{children:`Or join by code`}),(0,q.jsxs)(Yc,{children:[(0,q.jsx)(Jc,{id:`lobby-code`,code:!0,value:y,maxLength:4,placeholder:`CODE`,onChange:e=>b(e.target.value.toUpperCase())}),(0,q.jsx)(wc,{id:`lobby-join`,small:!0,active:w&&y.trim().length===4,onClick:O,children:`JOIN`})]})]})]})}function _l({seats:e,hostSeatId:t,seatId:n}){return(0,q.jsx)(Uc,{id:`lobby-seats`,children:e.map(e=>(0,q.jsxs)(Wc,{dim:!e.connected,id:`lobby-seat-${e.name}`,...Number.isFinite(e.rating)?{"data-rating":e.rating}:{},children:[(0,q.jsxs)(`span`,{children:[e.name,e.id===n?` (you)`:``]}),(0,q.jsxs)(Gc,{children:[Number.isFinite(e.rating)&&(0,q.jsx)(Kc,{children:e.rating}),(0,q.jsxs)(qc,{children:[e.id===t?`host`:``,e.connected?``:` offline`]})]})]},e.id))})}function vl({session:e}){let{code:t,roomName:n,roomPrivate:r,seats:i,hostSeatId:a,seatId:o,actions:s}=e,c=o&&o===a,l=i.length>=2,u=`${window.location.origin}${window.location.pathname}#/r/${t}`;return(0,q.jsxs)(Bc,{children:[(0,q.jsx)(vc,{children:r?`Private room`:`Room`}),(0,q.jsx)(tl,{id:`lobby-room-title`,children:n}),(0,q.jsx)(vc,{children:`Room code`}),(0,q.jsx)(Vc,{id:`lobby-room-code`,children:t}),(0,q.jsx)(Hc,{id:`lobby-share`,children:u}),(0,q.jsxs)(vc,{children:[`Players (`,i.length,`/`,6,`)`]}),(0,q.jsx)(_l,{seats:i,hostSeatId:a,seatId:o}),(0,q.jsx)(Mc,{}),(0,q.jsxs)(Tc,{children:[c?(0,q.jsx)(wc,{id:`lobby-start`,active:l,onClick:s.start,children:`START`}):(0,q.jsx)(Xc,{id:`lobby-waiting`,children:`Waiting for the host to start…`}),(0,q.jsx)(Nc,{id:`lobby-leave`,label:`LEAVE ROOM`})]}),c&&!l&&(0,q.jsxs)(Xc,{children:[`At least `,2,` players are needed.`]})]})}function yl(){let e=Ws(),{status:t,seatId:n,error:r,errorSeconds:i,actions:a}=e,o=!!n,s=t===`reconnecting`;return(0,q.jsxs)(zc,{children:[(0,q.jsxs)(_c,{children:[(0,q.jsx)(Dc,{}),`Hidden Agenda`]}),t===`connecting`&&(0,q.jsx)(Xc,{id:`lobby-connecting`,children:`Connecting…`}),t===`reconnecting`&&o&&(0,q.jsx)(Xc,{id:`lobby-reconnecting`,children:`Reconnecting…`}),r&&(0,q.jsx)(Xc,{bad:!0,id:`lobby-error`,children:ul(r,i)}),o?(0,q.jsx)(vl,{session:e}):(0,q.jsx)(gl,{session:e,unreachable:s}),!o&&(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`play-hotseat-btn`,small:!0,active:!0,onClick:a.goHotSeat,children:`PLAY HOT-SEAT INSTEAD`})}),s&&(0,q.jsx)(Xc,{id:`lobby-no-server`,children:`No server answered. Hot-seat plays in this tab and needs none.`})]})]})}var bl=G.div`
	position: relative;
	display: flex;
	flex-direction: column;
	gap: 18px;
...
`;function Al({n:e,numberPlayers:t,onChange:n}){let r=(0,v.useCallback)(e=>n(parseInt(e.target.value,10)),[n]);return(0,q.jsxs)(`div`,{children:[(0,q.jsx)(`input`,{type:`radio`,id:`players${e}`,name:`number-players`,value:e,defaultChecked:e===t,onChange:r}),(0,q.jsx)(El,{htmlFor:e,children:e})]},`players${e}`)}function jl({n:e,onChange:t}){let n=(0,v.useCallback)(e=>t(e.target.name,e.target.value),[t]);return(0,q.jsxs)(Ol,{children:[(0,q.jsxs)(wl,{children:[`PLAYER `,e]}),(0,q.jsx)(kl,{type:`text`,id:`player-name${e}`,name:`player${e}`,onChange:n})]},`player${e}`)}function Ml(e,t,n){let[r,i]=(0,v.useContext)(Rs);return(0,v.useCallback)(()=>{n&&(i(Ra(Object.values(e))),t())},[e,i,t,n])}function Nl(e,t){return(0,v.useMemo)(()=>Object.values(t).filter(e=>e).length===e,[e,t])}function Pl(e){let[t,n]=(0,v.useState)(Object.keys(e).length),[r,i]=(0,v.useState)(e),a=(0,v.useCallback)(e=>{n(e),i(Object.entries(r).slice(0,e).reduce((e,[t,n])=>({...e,[t]:n}),{}))},[r]),o=(0,v.useCallback)((e,t)=>i({...r,[e]:t.toUpperCase()}),[r]);return[{players:r,numberOfPlayers:t},{onNumberPlayersChange:a,onSelectPlayerOptions:o}]}function Fl({onReady:e}){let[t,n]=Pl({player1:void 0,player2:void 0}),{players:r,numberOfPlayers:i}=t,{onNumberPlayersChange:a,onSelectPlayerOptions:o}=n,s=Nl(i,r),c=Ml(r,e,s),l=Ws();return(0,q.jsxs)(bl,{children:[(0,q.jsxs)(xl,{children:[(0,q.jsxs)(Sl,{children:[(0,q.jsx)(Cl,{children:`1. NUMBER OF PLAYERS`}),(0,q.jsx)(Tl,{children:[,,,,,].fill().map((e,t)=>(0,q.jsx)(Al,{n:t+2,numberPlayers:i,onChange:a},`${t+2}`))})]}),(0,q.jsx)(Cl,{children:`2. PLAYERS`}),(0,q.jsx)(Dl,{children:Array(i).fill().map((e,t)=>(0,q.jsx)(jl,{n:t+1,onChange:o},t+1))})]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`start-btn`,active:s,onClick:c,children:`GET ALIGNMENTS`})}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`play-online-btn`,small:!0,active:!0,onClick:l.actions.goOnline,children:`PLAY ONLINE INSTEAD`})})]})}var Il=({alignment:e})=>e===`friend`?`var(--ha-friend)`:`var(--ha-foe)`,Ll=({disabled:e})=>{if(!e)return W`
...
`,Ul=G.i`
	...
	letter-spacing: var(--ha-track-label);
	text-transform: uppercase;
	background: color-mix(in srgb, ${Il} var(--ha-card-label-fill), transparent);
	color: color-mix(in srgb, ${Il} var(--ha-card-label-tint), var(--ha-card-label-ink));
...
`,Zl=G.span`
	...
	text-transform: uppercase;
	color: var(--ha-card-note-ink);
`,Ql={friend:`Friend`,foe:`Foe`},$l={friend:`their points are yours`,foe:`their points come off yours`};function eu(e){let{children:t,team:n,alignment:r}=e,i=!!t&&n!=null;return(0,q.jsxs)(Hl,{...e,children:[(0,q.jsx)(Ul,{alignment:r,children:Ql[r]}),i&&(0,q.jsxs)(Wl,{children:[(0,q.jsx)(Gl,{team:n,"data-team":n,children:t}),(0,q.jsxs)(Kl,{children:[(0,q.jsx)(ql,{team:n}),(0,q.jsxs)(Jl,{children:[(0,q.jsxs)(Yl,{children:[`team `,n]}),(0,q.jsx)(Xl,{children:Xn[n]})]})]})]}),(0,q.jsx)(Zl,{children:$l[r]})]})}function tu(e){return(0,q.jsx)(eu,{alignment:`friend`,...e})}function nu(e){return(0,q.jsx)(eu,{alignment:`foe`,...e})}var ru=[`0`,`1`,`2`,`3`],iu=2;function au(){return ru.reduce((e,t)=>e.concat(Array(iu).fill(t)),[])}function ou(e,t,n){let r=e.filter(e=>e!==t),i=r.length?r:e,a=i[Math.floor(n()*i.length)];return e.splice(e.indexOf(a),1),a}function su(e,t=Math.random){let n=au(),r=au();return e.map(e=>{let i=ou(n,void 0,t);return{name:e,friend:i,foe:ou(r,i,t)}})}var cu=G.div`
	position: relative;
	display: flex;
	flex-direction: column;
	align-items: center;
...
`;function lu(e){let[t]=(0,v.useState)(()=>su(e.map(e=>e.name)).reduce((e,t)=>({...e,[t.name]:t}),{}));return t}function uu(e){let[{players:t},n]=(0,v.useContext)(Rs),[r,i]=(0,v.useState)(t[0].name),a=lu(t),[o,s]=(0,v.useState)({friend:!1,foe:!1}),c=(0,v.useCallback)(()=>s({friend:!1,foe:!1}),[s]),l=(0,v.useCallback)(()=>{r||e(),c(),i(e=>{let n=t.findIndex(t=>t.name===e);return n===t.length-1?null:t[n+1].name})},[t,r,e,c,i]),u=(0,v.useMemo)(()=>{let e=t.find(e=>e.name===r);return e?e.alignment.friend:null},[t,r]),d=(0,v.useMemo)(()=>{let e=t.find(e=>e.name===r);return e?e.alignment.foe:null},[t,r]);return{cardsRevealed:o,revealFriend:(0,v.useCallback)(()=>{o.friend||(n(Ba({name:r,friend:a[r].friend})),s(e=>({friend:!0,foe:e.foe})))},[r,s,o,a,n]),revealFoe:(0,v.useCallback)(()=>{o.foe||(n(Ba({name:r,foe:a[r].foe})),s(e=>({friend:e.friend,foe:!0})))},[r,s,o,a,n]),playerTurn:r,currentFriend:u,currentFoe:d,nextTurn:l}}function du(e){return e?(0,q.jsxs)(q.Fragment,{children:[(0,q.jsxs)(_c,{children:[`This is only for `,e,`'s eyes`]}),(0,q.jsx)(vc,{children:`Expose your alignments`})]}):(0,q.jsx)(_c,{children:`You are all ready to start!`})}function fu({onReady:e}){let[{players:t}]=(0,v.useContext)(Rs),n=Ws(),[r,i]=(0,v.useState)(!1),a=t.find(e=>e.name===n.name),o=(0,v.useCallback)(()=>{i(!0),e()},[e]);if(!a)return(0,q.jsx)(cu,{children:(0,q.jsx)(_c,{children:`Waiting for the table…`})});let s=n.seats.filter(e=>e.ready).length;return(0,q.jsxs)(cu,{children:[(0,q.jsxs)(_c,{children:[a.name,`, these are yours`]}),(0,q.jsx)(vc,{children:`Nobody else can see them`}),(0,q.jsxs)(Vl,{children:[(0,q.jsx)(tu,{id:`alingnment-card-friend`,disabled:!0,player:a.name,team:a.alignment.friend,children:Xn[a.alignment.friend]}),(0,q.jsx)(nu,{id:`alingnment-card-foe`,disabled:!0,player:a.name,team:a.alignment.foe,children:Xn[a.alignment.foe]})]}),(0,q.jsxs)(Tc,{children:[(0,q.jsx)(wc,{id:`alignments-btn`,active:!r,onClick:o,children:r?`WAITING…`:`READY`}),(0,q.jsx)(Nc,{})]}),(0,q.jsxs)(vc,{id:`alignment-ready-count`,children:[s,`/`,n.seats.length,` ready`]}),(0,q.jsx)(Mc,{})]})}function pu({onReady:e}){let{cardsRevealed:t,revealFriend:n,revealFoe:r,playerTurn:i,currentFriend:a,currentFoe:o,nextTurn:s}=uu(e),c=Object.values(t).every(e=>e)||!i;return(0,q.jsxs)(cu,{children:[du(i),i&&(0,q.jsxs)(Vl,{children:[(0,q.jsx)(tu,{id:`alingnment-card-friend`,player:i,team:a,disabled:t.friend,onClick:n,children:Xn[a]}),(0,q.jsx)(nu,{id:`alingnment-card-foe`,player:i,disabled:t.foe,team:o,onClick:r,children:Xn[o]})]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`alignments-btn`,active:c,onClick:s,children:i?`NEXT PLAYER`:`START`})}),(0,q.jsx)(Mc,{})]})}function mu({online:e,onReady:t}){return e?(0,q.jsx)(fu,{onReady:t}):(0,q.jsx)(pu,{onReady:t})}var hu=G.div`
	position: relative;
	display: flex;
	flex-direction: column;
	justify-content: space-around;
...
`,{AGENT:gu,CEO:_u,SPY:vu,SNIPER:yu}=vn,bu=Math.sqrt(3)*1,xu=1.5,Su=3;function Cu(e){return On[e]===void 0?7-Math.abs(e-Su):On[e]}function wu(e,t){return{x:(t-(Cu(e)-1)/2)*bu,z:(e-Su)*xu}}var Tu={width:9*bu,depth:9*xu},Eu=Tu.width/(Tu.depth*Math.sin(52*Math.PI/180));function Du(e,t){return e>=0&&e<kn.length&&t>=0&&t<On[e]}function Ou(){let e=[],t=[-1,...kn,kn.length];for(let n of t){let t=Cu(n);for(let r=-1;r<=t;r++)e.push({row:n,cell:r,playable:Du(n,r),...wu(n,r)})}return e}var ku={"1,0":30,"1,1":-30,"0,0":90,"0,1":-90,"-1,0":150,"-1,1":-150};function Au(e){if(!e)return 0;let t=ku[`${e[0]},${e[1]}`];return t===void 0?0:t}var ju=[{type:gu,number:`3`,column:0,row:0},{type:gu,number:`2`,column:-.5,row:1},{type:gu,number:`4`,column:.5,row:1},{type:gu,number:`1`,column:-1,row:2},{type:_u,number:``,column:0,row:2},{type:gu,number:`5`,column:1,row:2},{type:vu,number:``,column:-.5,row:3},{type:yu,number:``,column:.5,row:3}];function Mu(){return ju.map(e=>({key:`${e.type}${e.number}`,x:e.column*bu,z:(e.row-3/2)*xu}))}function Nu(e){return e.slice(2)}var Pu=G.div`
	position: relative;
	display: flex;
	flex-direction: column;
	align-items: center;
...
`,id=G.div`
	...
	justify-content: center;
	width: 100%;
`,ad=G.button.attrs(({active:e})=>({disabled:!e}))`
	display: flex;
	flex-direction: column;
	align-items: flex-start;
	gap: 6px;
...
`,pd=G.div`
	...
	${({dimensional:e})=>{if(e)return W`
			...
			margin: 0;
		`}}
`,md=({dimensional:e})=>{if(e)return W`
...
`,Dd=G(Ed)`
	...
	text-shadow: none;
`,Od=`#445873`,kd={plinth:`#1a222d`,plinthEdge:`#42546b`,centre:`#d8c188`};function Ad(e){return{...kd,...ln[e]||ln[en]}}var jd=[[0,3,3,6],[3,2,4,2,3],[3,4,3,0,4,3],[6,2,0,0,3,2,0],[3,4,3,0,4,3],[3,2,4,2,3],[0,3,3,6]],Md={0:`#a1abb7`,2:`#7e8c9c`,3:`#6d7d8f`,4:`#606d7d`,6:`#464f5b`};function Nd(e){return[1,3,5].map(t=>parseInt(e.slice(t,t+2),16))}function Pd(e,t,n){let r=Nd(e),i=Nd(t);return`#${r.map((e,t)=>Math.round(e+(i[t]-e)*n).toString(16).padStart(2,`0`)).join(``)}`}function Fd(e,t){let n=Md[(jd[e]||[])[t]||0]||Md[0];return{face:n,chamfer:Pd(n,`#dce6f2`,.34),wall:Pd(n,`#0b0f14`,.55)}}var Id={0:{body:`#3d3843`,rim:`#c7d2e3`,collar:`#14171d`},1:{body:`#4b0313`,rim:`#e23048`,collar:`#14171d`},2:{body:`#bfbcc6`,rim:`#2a2d35`,collar:`#2a2d35`},3:{body:`#3a2f00`,rim:`#e9bb1c`,collar:`#14171d`}},Ld={0:{deck:`#8d949f`,socket:`#5d646f`,frame:`#c8ccd3`},1:{deck:`#5e2028`,socket:`#3b1219`,frame:`#d0293f`},2:{deck:`#2a2d34`,socket:`#191b20`,frame:`#8f959f`},3:{deck:`#6b5a1c`,socket:`#463a10`,frame:`#e9bb1c`}},Rd=`#ff3b30`,zd=`#ffe9b0`,Bd=`#ff2d20`,Vd=`#ffd77a`,Hd=`#000000`,Ud=`#8fc0ff`,Wd=`#e8eef7`,Gd=`#161b24`,Kd=G.div`
	position: relative;
	${({team:e})=>W`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		`},_E=7,vE=e=>({"-1":14,0:_E,1:0,2:-7,3:-14,4:-7,5:0,6:_E,7:14})[e],yE=e=>e<0||e>=kn.length,bE=(e,t)=>t<0||t>=(On[e]||3),xE=e=>[dE,fE,mE,hE].includes(e),SE=(e,t,n)=>xE(n)||bE(e,t)?`absolute`:`relative`,CE=(e,t)=>yE(e)&&!bE(e,t)?`initial`:t>=0?`unset`:`${vE(e)}%`,wE=(e,t)=>yE(e)&&!bE(e,t)?`initial`:t<0?`unset`:`${vE(e)}%`,TE=e=>({row:t,cell:n,edge:r})=>r?W`
				background: none;
				position: ${SE(t,n,e)};
				left: ${CE(t,n)};
				right: ${wE(t,n)};
				z-index: 1;
			`:W`
			background: ${oE(e)({row:t,cell:n})};
		`,EE=G.div`
	width: calc((100% - ${lE}px) / ${cE});
	height: 0;
	padding-bottom: 7.8%;
	position: relative;
	margin-right: ${sE}px;
	...
	${({projected:e})=>{if(e)return W`
		...
		`}}
`,DE={left:`6%`,top:`-6%`,width:`88%`,height:`96%`};function OE({row:e,cell:t,piece:n,highlighted:r,edge:i,aim:a,box:o,onHover:s}){let[c,l]=(0,v.useContext)(Rs),u=qs(),{isClickSuppressed:d}=sc(),f=(0,v.useCallback)(n=>{n&&n.preventDefault&&n.preventDefault(),n&&n.stopPropagation&&n.stopPropagation(),!d()&&u([e,t])},[u,d,e,t]),p=(0,v.useCallback)(()=>{if(s&&s([e,t]),!a)return;let n=Jn.getDirection(a.from,[e,t]);Cn(n,a.directions)&&l(Ya(n))},[a,l,s,e,t]);return(0,q.jsx)(EE,{id:`hex-${e}-${t}`,highlighted:r,row:e,cell:t,edge:i,projected:!!o,style:o,onClick:f,onMouseEnter:p,children:n&&(0,q.jsx)(Fw,{...n,box:o&&DE})})}var kE=3,AE=On.indexOf(Math.max(...On)),jE=On.reduce((e,t)=>e+t,0),ME=Math.max(...On),NE={A:`AGENT`,C:`CEO`,S:`SPY`,N:`SNIPER`};function PE(e,t,n){let r=[];for(let i=-1;i<=t;i++)r.push((0,q.jsx)(OE,{row:e,cell:i,edge:i===-1||i===t||e<0||e>=kn.length,piece:K.getPieceAtPosition([e,i],n.pieces),highlighted:Cn([e,i],n.highlightedPositions),aim:n.aim,onHover:n.onHover,box:n.layout&&n.layout[`${e}-${i}`]},`hex-${e}-${i}`));return(0,q.jsx)(pd,{dimensional:!!n.layout,children:r},`row-${e}`)}function FE(e){return e?{x:parseFloat(e.left)+parseFloat(e.width)/2,y:parseFloat(e.top)+parseFloat(e.height)/2}:null}function IE({layout:e,piece:t}){if(!t||!t.position)return null;let n=FE(e[`${t.position[0]}-${t.position[1]}`]);return n?(0,q.jsxs)(_d,{style:{left:`${n.x}px`,top:`${n.y}px`},children:[(0,q.jsx)(`i`,{children:K.getNumber(t.id)||K.getType(t.id)}),(0,q.jsxs)(`b`,{children:[t.id,` · `,NE[K.getType(t.id)],`, TEAM `,K.getTeam(t.id)]})]}):null}function LE({layout:e,selected:t}){if(!e)return null;let n=FE(e[`${kn.length}-1`]);return(0,q.jsxs)(hd,{"aria-hidden":`true`,children:[(0,q.jsx)(vd,{children:(0,q.jsxs)(`span`,{children:[ME,` CELLS · `,jE,` PLAYABLE`]})}),kn.map(t=>{let n=FE(e[`${t}--1`]);return n&&(0,q.jsx)(gd,{style:{left:`${n.x}px`,top:`${n.y}px`},children:t},`row-${t}`)}),n&&On.map((t,r)=>{let i=FE(e[`${AE}-${r}`]);return i&&(0,q.jsx)(gd,{style:{left:`${i.x}px`,top:`${n.y}px`},children:r},`cell-${r}`)}),(0,q.jsx)(IE,{layout:e,piece:t})]})}function RE(){let[{pieces:e,pieceState:t,snipe:n}]=(0,v.useContext)(Rs),r=(0,v.useRef)(null),i=dc(),[a,o]=(0,v.useState)(null),s=(0,v.useCallback)(e=>o(t=>t&&e&&t[0]===e[0]&&t[1]===e[1]?t:e),[]),c=(0,v.useCallback)(()=>o(null),[]),l=(0,v.useMemo)(()=>K.getHighlightedPositions(e,t),[e,t]),u=K.getSelectedPiece(e),d=!!u&&!!u.position&&!l.length,f=(0,v.useMemo)(()=>d?{from:u.position,directions:K.getPossibleDirections(u,e,t)}:null,[d,u,e,t]),p=(0,v.useMemo)(()=>({pieces:e,highlightedPositions:l,snipe:n,aim:f,hovered:a}),[e,l,n,f,a]),m=Nw(r,(0,v.useCallback)(e=>Zw(e,i),[i]),p),h={pieces:e,highlightedPositions:l,layout:m,aim:f,onHover:m?s:void 0};return(0,q.jsxs)(fd,{id:`board`,ref:r,dimensional:!!m,onMouseLeave:c,children:[(0,q.jsx)(LE,{layout:m,selected:u}),PE(-1,kE,h),kn.map(e=>PE(e,On[e],h)),PE(kn.length,kE,h)]})}function zE(e){let[t,n]=(0,v.useState)(e);return[t,(0,v.useCallback)(()=>n(!0),[]),(0,v.useCallback)(()=>n(!1),[])]}var BE={friend:`friend`,foe:`foe`};function VE(e){let t=[];return e.revealed.friend&&t.push(`friend: ${Xn[e.alignment.friend]}`),e.revealed.foe&&t.push(`foe: ${Xn[e.alignment.foe]}`),t.length?t.join(` · `):`nothing public yet`}function HE(e,t,n){return e.allowedToAccuse[n]?t.revealed[n]?`already public`:null:`you guessed a ${BE[n]} wrong already`}function UE({onClose:e}){let[{players:t},n]=(0,v.useContext)(Rs),[r,i]=(0,v.useState)(null),[a,o]=(0,v.useState)(null),[s,c]=(0,v.useState)(!1),l=t.find(e=>e.turn),u=t.find(e=>e.name===r)||null,d=s?l.lastAccusation:null,f=(0,v.useCallback)(e=>{n(so({accuser:l.name,accusee:r,alignment:a,team:e})),i(null),o(null),c(!0)},[n,l.name,r,a]);if(d){let t=d.accusee,n=BE[d.alignment];return(0,q.jsx)(Wu,{id:`accuse-screen`,role:`dialog`,"aria-modal":`true`,"aria-label":`Your accusation`,children:(0,q.jsxs)(Gu,{children:[(0,q.jsx)(rd,{children:`Your accusation`}),(0,q.jsxs)(sd,{id:`accuse-verdict`,$correct:d.correct,children:[(0,q.jsx)(cd,{id:`accuse-outcome`,$correct:d.correct,children:d.correct?`Correct`:`Wrong`}),(0,q.jsxs)(ld,{id:`accuse-detail`,children:[t,`'s `,n,` `,d.correct?`is`:`is not`,` `,Xn[d.team]]}),(0,q.jsx)(ud,{id:`accuse-consequence`,children:d.correct?`it is public now, and it cost ${t} 50 points`:`you may never accuse a ${n} again`})]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`accuse-close`,active:!0,onClick:e,children:`BACK TO THE BOARD`})})]})})}return(0,q.jsx)(Wu,{id:`accuse-screen`,role:`dialog`,"aria-modal":`true`,"aria-label":`Accuse a player`,children:(0,q.jsxs)(Gu,{children:[!u&&(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(rd,{children:`Accuse whom?`}),(0,q.jsx)(Ku,{children:`a wrong guess costs you that accusation for the rest of the game`}),(0,q.jsx)(id,{children:t.map((e,n)=>jr.isPlayerTurn(t,e)?null:(0,q.jsxs)(ad,{id:`accuse-player-${n}`,type:`button`,active:!0,onClick:()=>i(e.name),children:[e.name,(0,q.jsx)(od,{children:VE(e)})]},e.name))})]}),u&&!a&&(0,q.jsxs)(q.Fragment,{children:[(0,q.jsxs)(rd,{children:[u.name,`'s what?`]}),(0,q.jsx)(id,{children:[`friend`,`foe`].map(e=>{let t=HE(l,u,e);return(0,q.jsxs)(ad,{id:`accuse-${e}`,type:`button`,active:!t,onClick:()=>!t&&o(e),children:[BE[e],t&&(0,q.jsx)(od,{children:t})]},e)})})]}),u&&a&&(0,q.jsxs)(q.Fragment,{children:[(0,q.jsxs)(rd,{children:[u.name,`'s `,BE[a],` is which team?`]}),(0,q.jsx)(id,{children:Object.keys(Xn).map(e=>(0,q.jsx)(Dd,{id:`accuse-team-${e}`,active:!0,team:e,onClick:()=>f(e),children:Xn[e]},e))})]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`accuse-close`,active:!0,onClick:e,children:`CANCEL`})})]})})}function WE({onClose:e}){let[{players:t},n]=(0,v.useContext)(Rs),r=t.find(e=>e.turn),i=jr.isOwnFriendRevealed(t),a=jr.isOwnFoeRevealed(t),o=(0,v.useCallback)(()=>!i&&n(ro()),[i,n]),s=(0,v.useCallback)(()=>!a&&n(ao()),[a,n]),c=i&&a;return(0,q.jsx)(Wu,{id:`reveal-screen`,role:`dialog`,"aria-modal":`true`,"aria-label":`Reveal an alignment`,children:(0,q.jsxs)(Gu,{children:[(0,q.jsx)(rd,{children:c?`Both are public now`:`Reveal an alignment`}),(0,q.jsx)(Ku,{id:`reveal-note`,children:c?`nothing left to give away`:`costs 50 points, and hands you that team at once`}),(0,q.jsxs)(Vl,{children:[(0,q.jsx)(tu,{id:`reveal-friend`,active:!i,disabled:i,player:r.name,team:i?r.alignment.friend:void 0,onClick:o,children:i?Xn[r.alignment.friend]:null}),(0,q.jsx)(nu,{id:`reveal-foe`,active:!a,disabled:a,player:r.name,team:a?r.alignment.foe:void 0,onClick:s,children:a?Xn[r.alignment.foe]:null})]}),(i||a)&&(0,q.jsxs)(ud,{id:`reveal-spent`,children:[`−`,50*(Number(i)+Number(a)),` points spent on revealing`]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`reveal-close`,active:!0,onClick:e,children:i||a?`BACK TO THE BOARD`:`REVEAL NOTHING`})})]})})}function GE(){let e=Ws(),[{players:t}]=(0,v.useContext)(Rs);return(0,v.useMemo)(()=>e.mode===`online`?t.find(t=>t.name===e.name)||null:t.find(e=>e.turn)||null,[e.mode,e.name,t])}function KE(e,t){let n=e.exposed&&e.exposed[t];return n?`accused by ${n}`:`revealed`}function qE({player:e}){let t=jr.getBaseScore(e);return(0,q.jsxs)(Zu,{id:`ledger-score-${e.name}`,"data-base":t,$spent:t<100,children:[(0,q.jsx)(td,{children:`on`}),t]})}function JE({players:e,own:t}){return(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(qu,{id:`friend-foe-ledger`,children:e.map(e=>{let n=!!t&&e.name===t.name,{friend:r,foe:i}=e.alignment;return(0,q.jsxs)(Ju,{$own:n,children:[(0,q.jsxs)(Yu,{children:[(0,q.jsxs)(Xu,{children:[e.name,n?` (you)`:``]}),(0,q.jsx)(qE,{player:e})]}),(0,q.jsxs)($u,{children:[(0,q.jsxs)(ed,{$alignment:`friend`,children:[(0,q.jsx)(td,{children:`friend`}),n||e.revealed.friend?Xn[r]:(0,q.jsx)(nd,{"aria-label":`withheld`}),e.revealed.friend&&(0,q.jsx)(dd,{children:KE(e,`friend`)})]}),(0,q.jsxs)(ed,{$alignment:`foe`,children:[(0,q.jsx)(td,{children:`foe`}),n||e.revealed.foe?Xn[i]:(0,q.jsx)(nd,{"aria-label":`withheld`}),e.revealed.foe&&(0,q.jsx)(dd,{children:KE(e,`foe`)})]})]})]},e.name)})}),(0,q.jsxs)(Qu,{id:`friend-foe-base-note`,children:[`everyone is on `,100,` · an alignment becoming public costs its owner `,50,` · the teams are counted at the end`]})]})}function YE({onClose:e}){let[{players:t}]=(0,v.useContext)(Rs),n=Ws(),r=GE(),i=n.mode===`online`,[a,o]=(0,v.useState)(i),s=r?r.name:``;return(0,q.jsx)(Wu,{id:`friend-foe-screen`,role:`dialog`,"aria-modal":`true`,"aria-label":`Your friend and foe`,children:(0,q.jsxs)(Gu,{children:[(0,q.jsx)(Ku,{id:`friend-foe-eyes`,children:i?`nobody else can see these`:`only for ${s}'s eyes`}),!a&&(0,q.jsx)(Tc,{children:(0,q.jsxs)(wc,{id:`friend-foe-confirm`,active:!0,onClick:()=>o(!0),children:[s,` IS LOOKING`]})}),a&&r&&(0,q.jsxs)(q.Fragment,{children:[(0,q.jsxs)(Vl,{children:[(0,q.jsx)(tu,{id:`friend-foe-friend`,disabled:!0,player:r.name,team:r.alignment.friend,children:Xn[r.alignment.friend]}),(0,q.jsx)(nu,{id:`friend-foe-foe`,disabled:!0,player:r.name,team:r.alignment.foe,children:Xn[r.alignment.foe]})]}),(0,q.jsx)(JE,{players:t,own:r})]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(wc,{id:`friend-foe-close`,active:!0,onClick:e,children:`PUT IT AWAY`})})]})})}function XE({onClose:e}){let[{players:t}]=(0,v.useContext)(Rs),{actions:n}=Ws(),r=t.length-1<2;return(0,q.jsx)(Wu,{id:`leave-screen`,role:`dialog`,"aria-modal":`true`,"aria-label":`Leave the game`,children:(0,q.jsxs)(Gu,{children:[(0,q.jsx)(rd,{children:r?`End the game?`:`Leave the game?`}),(0,q.jsx)(Ku,{id:`leave-note`,children:r?`a game needs 2, so the last player leaves with you`:`the game carries on without you`}),(0,q.jsx)(ud,{id:`leave-cost`,children:r?`nobody scores, and the room is gone`:`a started room takes no new seats, so there is no way back`}),(0,q.jsx)(ud,{id:`leave-rating-cost`,children:`counts as a loss, and the next game waits on a timer`}),(0,q.jsxs)(id,{children:[(0,q.jsx)(wc,{id:`leave-confirm`,active:!0,onClick:n.leave,children:r?`END IT`:`LEAVE`}),(0,q.jsx)(wc,{id:`leave-close`,active:!0,onClick:e,children:`BACK TO THE BOARD`})]})]})})}function ZE(){let[{pieces:e,snipe:t},n]=(0,v.useContext)(Rs),r=Ks(),i=K.isSniperOnBoard(e);return[r,(0,v.useCallback)(()=>{i&&r&&n(Za())},[i,r,n]),t]}function QE(){let[e,t,n]=zE(!1),[r,i,a]=zE(!1),[o,s,c]=zE(!1),[l,u,d]=zE(!1);return{accuse:{shown:e,show:t,hide:n},reveal:{shown:r,show:i,hide:a},alignment:{shown:o,show:s,hide:c},leave:{shown:l,show:u,hide:d}}}function $E(){let[{players:e}]=(0,v.useContext)(Rs),t=Gs(),[n,r,i]=ZE(),a=QE(),o=e.find(e=>e.turn),s=jr.isRevealActive(e)&&t,c=(o.allowedToAccuse.friend||o.allowedToAccuse.foe)&&t;return(0,q.jsxs)(Iu,{children:[(0,q.jsx)(Lu,{children:(0,q.jsx)(wc,{id:`snipe`,small:!0,$primary:!0,active:n,onClick:r,children:i?`STAND DOWN`:`SNIPE!`})}),(0,q.jsxs)(Lu,{children:[(0,q.jsx)(Ed,{id:`accuse`,active:c,onClick:()=>c&&a.accuse.show(),children:`ACCUSE`}),(0,q.jsx)(Ed,{id:`reveal`,active:s,onClick:()=>s&&a.reveal.show(),children:`REVEAL`})]}),(0,q.jsxs)(Lu,{children:[(0,q.jsx)(wc,{id:`friend-foe`,small:!0,active:!0,onClick:a.alignment.show,children:`FRIEND & FOE`}),(0,q.jsx)(Nc,{onClick:a.leave.show})]}),a.accuse.shown&&(0,q.jsx)(UE,{onClose:a.accuse.hide}),a.reveal.shown&&(0,q.jsx)(WE,{onClose:a.reveal.hide}),a.alignment.shown&&(0,q.jsx)(YE,{onClose:a.alignment.hide}),a.leave.shown&&(0,q.jsx)(XE,{onClose:a.leave.hide})]})}function eD(){let[{players:e,pieces:t,hasTurnEnded:n},r]=(0,v.useContext)(Rs),i=Gs(),a=jr.getTurn(e),o=K.getKilledCeoCount(t),s=e.findIndex(e=>e.turn);return(0,q.jsxs)(_c,{children:[(0,q.jsxs)(Ru,{children:[(0,q.jsx)(zu,{children:`on the desk of`}),(0,q.jsx)(Vu,{id:`turn-player`,children:a}),(0,q.jsx)(Hu,{"aria-hidden":`true`,children:e.map((e,t)=>(0,q.jsx)(Uu,{$on:t<s,children:e.name.charAt(0)},e.name))})]}),(0,q.jsx)(Ru,{children:(0,q.jsxs)(Bu,{children:[(0,q.jsx)(zu,{children:`ceos down`}),(0,q.jsxs)(Vu,{id:`ceos-down`,children:[o,` / `,3]})]})}),(0,q.jsx)(Ru,{children:(0,q.jsx)(wc,{small:!0,id:`next-turn`,active:n&&i,onClick:()=>n&&r(Ha()),children:`NEXT TURN`})})]})}function tD(){return(0,q.jsxs)(Pu,{children:[(0,q.jsx)(eD,{}),(0,q.jsxs)(Fu,{children:[(0,q.jsxs)(hu,{children:[(0,q.jsx)(Lw,{team:`0`}),(0,q.jsx)(Lw,{team:`1`})]}),(0,q.jsx)(RE,{}),(0,q.jsxs)(hu,{children:[(0,q.jsx)(Lw,{team:`2`}),(0,q.jsx)(Lw,{team:`3`})]})]}),(0,q.jsx)($E,{})]})}var nD=G.div`
	position: relative;
	display: flex;
	flex-direction: row;
	justify-content: space-evenly;
...
`,ED=G.div`
	...
	white-space: nowrap;
	min-width: 56px;
`;function DD({type:e}){let t=`img/0-${e}.png`;return(0,q.jsx)(qd,{src:t,killed:!0})}function OD(){return(0,q.jsxs)(cD,{children:[(0,q.jsxs)(lD,{children:[(0,q.jsxs)(uD,{children:[(0,q.jsx)(DD,{type:`A`}),` 5 pts`]}),(0,q.jsxs)(uD,{children:[(0,q.jsx)(DD,{type:`S`}),` 10 pts`]})]}),(0,q.jsxs)(lD,{children:[(0,q.jsxs)(uD,{children:[(0,q.jsx)(DD,{type:`N`}),` 10 pts`]}),(0,q.jsxs)(uD,{children:[(0,q.jsx)(DD,{type:`C`}),` 20 pts`]})]})]})}function kD(e,t){return`${e===`friend`?`+`:`−`} ${t}`}function AD({alignment:e,team:t,points:n,revealed:r}){return(0,q.jsxs)(SD,{alignment:e,"data-alignment":e,children:[(0,q.jsx)(CD,{team:t,children:Xn[t]}),(0,q.jsx)(wD,{"data-term":e===`friend`?n:-n,children:kD(e,n)}),r&&(0,q.jsxs)(TD,{"data-term":-50,children:[`− `,50]})]})}function jD({name:e}){let{rated:t}=Ws(),n=t?.players?.find(t=>t.name===e);return n?(0,q.jsxs)(bD,{"data-delta":n.delta,"data-rating":n.after,children:[n.delta>=0?`+`:`−`,Math.abs(n.delta),` → `,n.after]}):null}function MD({player:e}){let[{pieces:t}]=(0,v.useContext)(Rs),n=fr.getPointsForTeam(e.alignment.friend,t),r=fr.getPointsForTeam(e.alignment.foe,t);return(0,q.jsxs)(gD,{"data-player":e.name,children:[(0,q.jsxs)(_D,{children:[(0,q.jsxs)(vD,{children:[(0,q.jsx)(yD,{children:e.name}),(0,q.jsx)(jD,{name:e.name}),(0,q.jsx)(xD,{"data-term":100,children:100})]}),(0,q.jsx)(AD,{alignment:`friend`,team:e.alignment.friend,points:n,revealed:e.revealed.friend}),(0,q.jsx)(AD,{alignment:`foe`,team:e.alignment.foe,points:r,revealed:e.revealed.foe})]}),(0,q.jsx)(ED,{"data-total":jr.getPoints(e,t),children:jr.getPoints(e,t)})]})}function ND(){let[{players:e,pieces:t}]=(0,v.useContext)(Rs);return(0,q.jsxs)(fD,{children:[(0,q.jsx)(hD,{children:jr.sortByPoints(e,t).map(e=>(0,q.jsx)(MD,{player:e},e.name))}),(0,q.jsx)(pD,{big:!0,children:`Winner: `}),(0,q.jsx)(mD,{big:!0,children:jr.getWinner(e,t).name})]})}function PD({team:e}){let[{pieces:t}]=(0,v.useContext)(Rs);return(0,q.jsxs)(rD,{children:[fr.getPointsForTeam(e,t),(0,q.jsx)(iD,{children:`pts`})]})}function FD({team:e}){return(0,q.jsxs)(Kd,{team:e,children:[(0,q.jsx)(PD,{team:e}),(0,q.jsxs)(aD,{children:[(0,q.jsx)(oD,{children:`Killed:`}),(0,q.jsx)(tf,{team:e})]}),(0,q.jsxs)(aD,{children:[(0,q.jsx)(oD,{children:`Survivors:`}),(0,q.jsx)(rf,{team:e})]})]})}function ID(){return(0,q.jsxs)(nD,{children:[(0,q.jsxs)(hu,{children:[(0,q.jsx)(FD,{team:`0`}),(0,q.jsx)(FD,{team:`1`})]}),(0,q.jsxs)(dD,{children:[(0,q.jsx)(OD,{}),(0,q.jsx)(ND,{})]}),(0,q.jsxs)(hu,{children:[(0,q.jsx)(FD,{team:`2`}),(0,q.jsx)(FD,{team:`3`})]}),(0,q.jsx)(Tc,{children:(0,q.jsx)(Nc,{id:`end-leave`,label:`LEAVE GAME`})})]})}var{START:LD,ALIGNMENT:RD,PLAY:zD,END:BD}=fn,VD=[RD,zD,BD];function HD(){let[{pieces:e}]=(0,v.useContext)(Rs),t=Ws(),n=t.mode===`online`;fc(dc());let r=(n?t.phase===BD:K.hasGameFinished(e))?BD:t.phase,i=VD.includes(r)&&!t.synced;return(0,q.jsxs)(uc,{children:[(0,q.jsx)(dn,{}),(0,q.jsx)(xc,{}),i?(0,q.jsx)(_c,{children:`Loading the game…`}):(0,q.jsxs)(q.Fragment,{children:[(r===LD||r===null)&&(n?(0,q.jsx)(yl,{}):(0,q.jsx)(Fl,{onReady:()=>t.actions.advance(RD)})),r===RD&&(0,q.jsx)(mu,{online:n,onReady:()=>n?t.actions.ready():t.actions.advance(zD)}),r===zD&&(0,q.jsx)(tD,{}),r===BD&&(0,q.jsx)(ID,{})]})]})}var UD=Us(HD);(0,y.createRoot)(document.querySelector(`.game`)).render((0,q.jsx)(v.StrictMode,{children:(0,q.jsx)(UD,{})}));
//# sourceMappingURL=index-Pd9lY6vO.js.map